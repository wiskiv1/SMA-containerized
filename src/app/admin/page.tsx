...
export default function Admin() {
  return (
    <div style={{ height: "100%" }}>
      <div
        id="what_to_do_with_data"
        className="choices_buttons big_buttons"
        style={{ display: "none" }}
      >
        ...
        <div className="multiple_buttons_container">
          ...
          >
            <h2>Download data</h2>
            <p>
              oh, you data scientist. Gotcha, you can create your best data viz
          ...
          >
            <h2>Reset</h2>
            <p>
              Sometimes, you need to go back to a clean board to achieve beter.
              Good luck !
            </p>
          </div>
        </div>
      ...
      <div
        id="scheduler"
        className="scheduler_settings big_buttons"
        style={{ display: "none" }}
      >
        ...
        <div className="multiple_buttons_container">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(41deg, #5a5ca3  0%, #ed8ad2 100%)",
            }}
          >
            <h2>Start</h2>
            ...
            <p></p>
            <script>
              document.querySelector(&quot;#schedule_start
          ...
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(336deg, #7560a7 0%, #df6cbe 100%); height:fit-content",
            }}
          >
            <h2>Message</h2>
            <input type="text" />
        ...
        <div style={{ marginTop: "40px" }}>
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(193deg, #775ca9 0%, #ed8ad2 100%)",
            }}
          >
            Validate
          </div>
